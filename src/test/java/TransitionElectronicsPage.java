...
public class TransitionElectronicsPage {
    ...
    public void successfulSearch() {
        final String searchQuery = "Электроника";

        WebElement searchField = driver.findElement(By.xpath("//*[@id=\"column-center\"]/section/div[2]/a"));
